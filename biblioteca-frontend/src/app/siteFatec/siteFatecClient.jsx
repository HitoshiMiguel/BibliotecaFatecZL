...
function NoticiasCPS() {
  // novas notícias relacionadas ao acervo e biblioteca
  const NEWS = [
    {
      id: 1,
      img: '/images/biblio-acervo1.jpg',
      title: 'Biblioteca da Fatec ZL recebe novos títulos no acervo digital',
      date: '28 de outubro de 2025',
      href: '#',
      excerpt:
        'Foram adicionados mais de 300 novos e-books e periódicos acadêmicos, ampliando as possibilidades de pesquisa dos alunos.',
    },
    {
      id: 2,
      img: '/images/biblio-leitura.jpg',
      title: 'Projeto incentiva leitura com clube de livros e rodas de conversa',
      date: '22 de outubro de 2025',
      href: '#',
      excerpt:
        'A iniciativa busca estimular o hábito da leitura entre os estudantes, com encontros mensais e curadoria do corpo docente.',
    },
    {
      id: 3,
      img: '/images/biblio-renovacao.jpg',
      title: 'Sistema de empréstimo e renovação online é modernizado',
      date: '18 de outubro de 2025',
      href: '#',
      excerpt:
        'A nova interface do sistema permite solicitar empréstimos e renovar obras diretamente pelo site da biblioteca.',
    },
    {
      id: 4,
      img: '/images/biblio-exposicao.jpg',
      title: 'Exposição celebra o Dia Nacional do Livro na Fatec ZL',
      date: '15 de outubro de 2025',
      href: '#',
      excerpt:
        'Com o tema “O livro como ponte para o conhecimento”, a mostra reuniu obras raras e interativas no saguão da biblioteca.',
    },
  ];
  ...
  return (
    <section id="noticias" className={styles.newsSection} aria-labelledby="noticiasTitulo">
      <div className={styles.newsHeader}>
        <h2 id="noticiasTitulo" className={styles.newsTitle}>
          Últimas notícias sobre a Biblioteca
        </h2>
  ...
  return (
    <>
      ...
      <header
        ...
        role="img"
        aria-label="Estudantes na biblioteca - imagem de destaque"
      >
          ...
          <section className={styles.aboutLib}>
            ...
            <div className={styles.aboutRight}>
              <div className={styles.stat}>
                ...
                <div className={styles.statLabel}>títulos cadastrados</div>
              </div>
              <div className={styles.stat}>
                <div className={styles.statNumber}>25k+</div>
                <div className={styles.statLabel}>exemplares</div>
              </div>
              <div className={styles.stat}>
                <div className={styles.statNumber}>ABNT</div>
                <div className={styles.statLabel}>apoio à normalização</div>
              </div>
            </div>
          </section>
      ...
      <footer className={styles.govFooter}>
        <div className={styles.govFooterInner}>
          ...
          <div className={styles.govRight}>
            ...
            <button className={styles.govBtnColor} aria-label="Acessibilidade" title="Acessibilidade">
              ◎
            </button>
          </div>
        </div>
